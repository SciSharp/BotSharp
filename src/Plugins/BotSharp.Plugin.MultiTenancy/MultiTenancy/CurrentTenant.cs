...
public class CurrentTenant : ICurrentTenant
{
    ...
    private IDisposable SetCurrent(Guid? tenantId, string? name = null)
    {
        ...
        _currentTenantAccessor.Current = new TenantInfoBasic(tenantId, name);

        return new DisposeAction<ValueTuple<ICurrentTenantAccessor, TenantInfoBasic?>>(static (state) =>
        {
