...
using BotSharp.Plugin.A2A.Functions;
using BotSharp.Plugin.A2A.Hooks;
using BotSharp.Plugin.A2A.Services;
using BotSharp.Plugin.A2A.Settings;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace BotSharp.Plugin.A2A;
...
public class A2APlugin : IBotSharpPlugin
{
    ...
    { 
        ...
        services.AddScoped<IConversationHook, A2AConversationHook>();
